...
def battlestable():
    ...
    winnerinfo = cur.execute('SELECT commanderstable.firstname,commanderstable.lastname,commanderstable.nationality,armiestable.strength,battlestable.winner FROM armiestable, commanderstable WHERE battlestable.winner = armiestable.armyID AND armiestable.commanderID = commanderstable.ID AND battlestable.location = %s',[thisbattle])
    loserinfo = cur.execute('SELECT commanderstable.firstname,commanderstable.lastname,commanderstable.nationality,armiestable.strength,battlestable.loser FROM armiestable, commanderstable WHERE battlestable.loser = armiestable.armyID AND armiestable.commanderID = commanderstable.ID AND battlestable.location = %s',[thisbattle])
    mysql.connection.commit()
    cur.close()
